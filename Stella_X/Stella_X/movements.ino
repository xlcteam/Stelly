...
{
    int16_t speeds[] = { -spd, spd, 0 };//{ spd, -spd, 0 };
    move_PID(speeds);
}

inline void move_right(uint8_t spd)
{
    int16_t speeds[] = { -spd/2, -spd/2, spd };//{ spd/2, spd/2, -spd };
    move_PID(speeds);
}
...
{
    int16_t speeds[] = { -spd, 0, spd };// { spd, 0, -spd };
    move_PID(speeds);
}

inline void move_back_right(uint8_t spd)
{
    int16_t speeds[] = { 0, -spd, spd };//{ 0, spd, -spd };
    move_PID(speeds);
}
...
{
    int16_t speeds[] = { spd, spd, spd };//{ -spd, -spd, -spd };
    move_raw(speeds);
}
